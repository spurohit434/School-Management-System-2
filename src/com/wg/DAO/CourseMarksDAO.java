...
public class CourseMarksDAO {
	...
	public void addMarks(CourseMarks courseMarks) {
		...
		try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
			preparedStatement.setString(1, courseMarks.getUserId());
			preparedStatement.setString(2, courseMarks.getCourseId());
			preparedStatement.setDouble(3, courseMarks.getMarks());
